...
class NimadirPage extends StatefulWidget {
  static const path = 'albums_page';
  const NimadirPage({Key? key}) : super(key: key);

  @override
  State<NimadirPage> createState() => _NimadirPageState();
}

class _NimadirPageState extends State<NimadirPage> {
  List<Album>? _albums;
  bool _loading = false;
